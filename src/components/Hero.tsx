  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.sub}>Vi henter ferske sjødata for akkurat dine kyststeder, og leverer dem ferdig tilpasset til deg. Farevarsel på SMS — alltid på, uansett.</p>
