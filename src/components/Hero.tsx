  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <h1 className={styles.h1}>Opp klokken fem —<br/>men bare når<br/>det er <em>verdt det</em></h1>
        <p className={styles.sub}>Konkrete tall om bølger, vind og sjøtemperatur — levert på SMS til deg og familien hver morgen.</p>
