  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.sub}>Vi henter, analyserer og leverer ferske sjødata for akkurat dine kyststeder — ferdig tilpasset deg. Farevarsel på SMS alltid på, uansett.</p>
