  ...
  return (
    <div style={{minHeight:'100vh',background:'#e8f4f8',fontFamily:'DM Sans, sans-serif'}}>
      ...
      <div style={{maxWidth:720,margin:'0 auto',padding:'4rem 1.5rem'}}>
        <h1 style={{fontFamily:"'Fraunces', Georgia, serif",fontSize:'2.5rem',fontWeight:300,color:'#0a2a3d',marginBottom:'2rem'}}>Personvern</h1>
        <h2 style={{fontSize:'1.2rem',fontWeight:500,color:'#0a2a3d',marginTop:'2rem',marginBottom:'0.5rem'}}>Hvem er vi</h2>
        <p style={{color:'#2c4a5e',lineHeight:1.7}}>Bølgevarsel.no er en tjeneste drevet av Solidlab.ai, Stavanger. Kontakt: hei@bolgevarsel.no</p>
